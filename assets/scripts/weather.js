...
function renderWeather(data) {
  ...
  weatherSection.innerHTML = `
                            <div class="temperature-wrapper d-flex justify-center align-center">
                                <h2 class="temperature-digits d-flex align-center">${currentTempRound}°</h2>
                                <div class="temperature-emoji-wrapper">${weatherIcon(
                                  icon
                                )}</div>
                            </div>
                            <div class="temperature-description-wrapper d-flex justify-center align-center">
                                <div class="temperature-description-text">${descriptionText}</div>
                                <div class="temperature-description-emoji">${descriptionEmoji}</div>
                                </div>
                                <div class="temperature-min-max-wrapper d-flex justify-center align-center">
                                <div class="max-temperature-wrapper d-flex justify-center align-center">
                                ...
                                <div class="min-temperature-wrapper d-flex justify-center align-center">
